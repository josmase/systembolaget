...
angular.module('systembolagetApp')
  .service('getArticlesService', function ($http) {
    ...
    this.getArticles = function (search) {
      this.search = search;
      this.search.alcoholMin = (search.alcoholMin / 100) || 0;
      this.search.alcoholMax = (search.alcoholMax / 100) || 1;
      this.search.apkMin = search.apkMin || 0;
      this.search.apkMax = search.apkMax || 0;
      ...
      $http.get('https://karlroos-systemet.p.mashape.com/product', {
        ...
        params: {
          alcohol_from: this.search.alcoholMin,
          alcohol_to: this.search.alcoholMax,
